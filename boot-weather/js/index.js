(function () {
  ...
  //현재 위치 가져오기
  //navigator.geolocation.getCurrentPosition 위치정보 가져오기 성공할때, 위치정보 가져오기 실패할때);
  ...
  function laodMap(lat, lon) {
    ...
    function searchAddrFromCoords(coords, callback) {
      ...
      //collback: displayCenterInfo(result, status) 함수가 있다.
